...
- Se satisfacen de forma parcial los escenarios de calidad <a href="https://github.com/ramaaorella/final_disenio/blob/main/add-process/design-inputs/qa-scenarios/qa2.1-scenario.md">QA-2.1</a>, <a href="https://github.com/ramaaorella/final_disenio/blob/main/add-process/design-inputs/qa-scenarios/qa2.2-scenario.md">QA-2.2</a> y <a href="https://github.com/ramaaorella/final_disenio/blob/main/add-process/design-inputs/qa-scenarios/qa5.1-scenario.md">QA-5.1</a> en esta iteración. En cuanto a la modularidad, se ha logrado un avance al separar las responsabilidades entre el Gateway de mensajería y el Core, lo que facilita modificaciones independientes. Además, el diseño basado en microservicios, con bajo acoplamiento, comunicación asincrónica y orquestación descentralizada, mejora la capacidad de modificar y escalar los servicios involucrados en los flujos de mensajes entrantes y salientes, contribuyendo a la modularidad y escalabilidad del sistema. En cuanto a la portabilidad, si bien la arquitectura modular facilita este aspecto, aún queda por analizar las estrategias específicas para garantizar una transición eficiente entre entornos y plataformas. Si bien las decisiones actuales contribuyen en parte a cumplir con estos escenarios, será necesario seguir explorando y refinando las estrategias en iteraciones posteriores para satisfacer completamente estos escenarios, tanto en relación con los casos de uso pendientes como en términos de los objetivos de calidad que aún deben ser alcanzados.
- Se satisface de forma parcial el escenario de calidad <a href="https://github.com/ramaaorella/final_disenio/blob/main/add-process/design-inputs/qa-scenarios/qa4.2-scenario.md">QA-4.2</a>. La arquitectura incluye estrategias para manejar altas cargas, como priorización de mensajes y optimización de latencia. No obstante, será necesario incorporar estrategias adicionales que apunten a aumentar el throughput del sistema para cumplir plenamente con este escenario.
- Se satisface de forma parcial el escenario de calidad <a href="https://github.com/ramaaorella/final_disenio/blob/main/add-process/design-inputs/qa-scenarios/qa6.1-scenario.md">QA-6.1</a>. La tolerancia a fallos está respaldada por la orquestación descentralizada y la persistencia de mensajes, lo que evita puntos únicos de falla. Sin embargo, la recuperación frente a fallos específicos requiere mayor desarrollo en iteraciones posteriores.
