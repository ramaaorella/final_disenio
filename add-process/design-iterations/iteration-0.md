...
- **_Core (en forma abstracta):_** El Core deberá gestionar los flujos de mensajes, las solicitudes de los usuarios en el portal y los reportes en modo batch que se disparan, asegurando una operación eficiente y fluida del sistema. Esto implica mantener la trazabilidad de los mensajes, optimizar los flujos de datos y garantizar tiempos de procesamiento mínimos para mantener un buen rendimiento y una experiencia fluida e interactiva para los usuarios.
