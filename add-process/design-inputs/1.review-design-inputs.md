...
<dl><dd>
  <table>
    ...
    <tr>
      ...
      <td>
        <ins>Modularización para fácil manteniemiento</ins></br>
        <p align="justify">
    ...
    <tr>
      ...
      <td>Performance</td>
      <td>
        <ins>Procesamiento de mensajes entrantes con alto throughtput</ins></br>
        <p align="justify">
...
<dl>
  <dd>
    <p align="justify">
      El diseño parte desde una arquitectura nocional inicial (ya implementada a nivel propotipo), cuya documentación se encuentra en el siguiente <a href="https://github.com/ramaaorella/final_disenio/blob/main/add-process/design-inputs/0.unrefined-design-inputs.md#5-arquitectura-nocional-inicial">documento</a>,  y cuyo análisis se encuentra en el siguiente <a href="https://github.com/ramaaorella/final_disenio/blob/main/add-process/design-iterations/iteration-0.md">documento</a>.
    </p>
    <p align="center">
